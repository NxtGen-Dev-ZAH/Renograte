    ...
    <footer className="bg-gradient-to-r from-cyan-950 via-black to-cyan-950  text-white w-full overflow-hidden ">
      ...
      <div className="container mx-auto px-6 py-8 md:py-12 ">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* Brand column */}
          <div>
            <h3 className="text-2xl md:text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-500 ">
              Renograte{" "}
            </h3>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xl font-semibold mb-6 after:content-[''] after:block after:w-12 after:h-1 after:bg-blue-500 after:mt-2">
              Quick Links
            </h4>
