...
import { DollarSign, Clock, Wrench, Search, Check, X } from "lucide-react";
  ...
  const features = [
    {
      ...
      title: "Maximum Value",
      description:
        "Get top dollar for your distressed property without investing in repairs",
    },
    {
      icon: <Clock className="w-6 h-6 text-[#0C71C3]" />,
      title: "Quick Process",
      description:
        "Fast-track your sale with our streamlined renovation integration",
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-white to-cyan-50 pt-20">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          >
            ...
            <p className="text-gray-600 text-base md:text-lg">
              Don&apos;t let repair costs hold you back. With Renograte, sell
              your distressed property at market value while we handle all
              renovation aspects. Our unique pre-closing renovation program
              ensures maximum returns without any upfront costs.
            </p>
        ...
        <div className="container mx-auto px-4">
          <motion.div className="text-center mb-12" {...fadeInUp}>
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We transform the traditional home selling process by integrating
              renovations before closing, maximizing your property&apos;s value
      ...
      >
        <motion.div className="text-center mb-12" {...fadeInUp}>
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Our streamlined process makes selling your distressed property
          ...
          {[
            {
              ...
              description:
                "We evaluate your property's current condition and potential value after renovation.",
            },
            {
              step: "2",
              title: "Renovation Planning",
              description:
                "Our experts create a comprehensive renovation plan to maximize property value.",
            },
            {
              step: "3",
              title: "Buyer Matching",
              description:
                "We connect you with buyers interested in customizing their future home.",
            },
            {
              step: "4",
              title: "Closing & Renovation",
              description:
                "Complete the sale and let us handle the renovation process.",
            },
          ].map((step, index) => (
            <motion.div
              key={index}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto text-white/90">
              Get started today and discover how much value we can add to your
              property through our innovative renovation program.
            </p>
            ...
            {!showForm ? (
              ...
              >
                ...
                <p className="text-gray-600">
                  Thank you for your submission. A Renograte specialist will
                  contact you shortly to discuss your property.
                </p>
              </motion.div>
            ) : (
              <motion.div
              ...
              >
                ...
                <form onSubmit={handleSubmit} className="space-y-4 text-left">
                  ...
                  <div>
                    <label
                      htmlFor="isDeveloperOrWholesaler"
                      className="block text-sm font-medium text-gray-700 mb-1"
                    >
                      Are you a Real Estate Developer or Wholesaler?
                    </label>
                    <select
...
export default DistressedHomes;
