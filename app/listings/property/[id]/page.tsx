...
export function PropertyDetailPage() {
  ...
  const [neighboringProperties, setNeighboringProperties] = useState<
    Property[]
  >([]);
  ...
  const {
    ...
    error: apiError,
    loading,
  } = useRealtyFeedApi<PropertyResponse>(propertyQuery);
    ...
    const fetchNeighboringProperties = async () => {
      try {
        ...
        const response = await fetch(
          `/api/realtyfeed?resource=${encodeURIComponent(query)}`
        );
      ...
      <div className="flex flex-col container mx-auto px-4 py-8 mt-10">
                ...
                <>
                  ...
                  <div>
                    ...
                    <div className="text-2xl font-semibold text-blue-600">
                      {formatPrice(
                        calculateRenovationDetails(property).renovationAllowance
                      )}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="text-2xl font-semibold text-green-600">
                      {formatPrice(
                        calculateRenovationDetails(property)
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="mb-2">
              <strong>MLS #:</strong> {property.ListingKey}
            </p>
            {property.ListOfficeName && (
              <p className="mb-2">
                <strong>Listing Office:</strong> {property.ListOfficeName}
              </p>
            )}
        ...
        {property?.Latitude && property?.Longitude && (
          <div className="bg-white p-6 rounded-lg shadow-md mb-10">
            ...
            <p className="mt-4 text-gray-700">
              Located in {property.City}, {property.StateOrProvince}{" "}
              {property.PostalCode}
              {property.SubdivisionName &&
                ` in the ${property.SubdivisionName} subdivision`}
              .
              {neighboringProperties.length > 0 &&
                ` There are ${neighboringProperties.length} other properties for sale in this area.`}
            </p>
            ...
            {neighboringProperties.length > 0 ? (
                  ...
                  {neighboringProperties.slice(0, 9).map((nearbyProperty) => (
                    <div
                      ...
                      className={`border py-3 px-7 hover:bg-blue-50 cursor-pointer transition-colors  ${
                        hoveredPropertyId === nearbyProperty.ListingKey
                          ? "bg-blue-50 border-blue-400"
                          : ""
                      }`}
                      onClick={() =>
                        handleMarkerClick(nearbyProperty.ListingKey)
                      }
                      onMouseEnter={() =>
                        setHoveredPropertyId(nearbyProperty.ListingKey)
                      }
                    ...
                    >
                      ...
                      <div className="text-sm">
                        {nearbyProperty.StreetNumber}{" "}
                        {nearbyProperty.StreetName}
                      </div>
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-600">
                  We couldn&apos;t find any other properties listed in this
                  immediate area. You can browse more properties in{" "}
                  {property.City} by returning to the main listings.
                </p>
                <Link
                  href="/listings"
                  className="mt-4 inline-flex items-center text-blue-600 hover:text-blue-800"
        ...
        <div className="text-sm text-gray-500 mb-8">
          <p>
            Listing information provided courtesy of the{" "}
            {property.ListOfficeName || "listing broker"}. The information
            provided is for consumers&apos; personal, non-commercial use and may
            not be used for any purpose other than to identify prospective
            properties that consumers may be interested in purchasing.
          </p>
        </div>
